...
import org.tinygroup.dalpractice.keygenerate.MyKeyGenerater;
...
//    	 Map<String,KeyGenerator> generatorMap=new CaseInsensitiveMap(); 
//    	 generatorMap.put("id", new MyKeyGenerater());
//		return generatorMap;
//	}
